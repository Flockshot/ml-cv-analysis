...
[cite_start]The core of this project is the design of a **Nested Cross-Validation** framework [cite: 1] to ensure that model evaluation is statistically robust, unbiased, and free from data leakage.
...
[cite_start]A `ColumnTransformer` and `Pipeline` were constructed to handle the mixed-type credit dataset[cite: 6].
